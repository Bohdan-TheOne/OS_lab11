					...
					else
					{
						...
						while (true)
						{
							...
							if (iResult > 0)
							{
								...
								{
									MessageBox::Show("Connect", "Successfully connected", MessageBoxButtons::OK, MessageBoxIcon::Information);
									this->Hide();
								...
								{
									MessageBox::Show("Error connection", StdToSys(recvText.substr(4, recvText.size())), MessageBoxButtons::OK, MessageBoxIcon::Error);
								}
								break;
							}
						}
